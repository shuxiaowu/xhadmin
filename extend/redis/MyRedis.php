...
class MyRedis extends Model{
    ...
    public function __construct(){  
        $this->_HOST = config('REDIS_CONFIG.host');  
        $this->_PORT = config('REDIS_CONFIG.port');  
        $this->_TIMEOUT = config('REDIS_CONFIG.timeout');  
        $this->_DBNAME = config('REDIS_CONFIG.dbname');  
        $this->_CTYPE = config('REDIS_CONFIG.type');  
     ...
     */  
    public function sets($key,$value,$type=0,$repeat=0,$time=0,$old=0)  
    {  
        $return = null;  
     ...
     */  
    public function gets($key=null,$start=null,$end=null)  
    {  
        $return = null;  
